...
public class GuiHobbyOrganicInfuser extends GuiContainer {
	
	public ResourceLocation texture = new ResourceLocation(Oreganic.modid + ":" + "textures/gui/organicinfuser.png");
	public TileEntityHobbyOrganicInfuser hobbyOrganicInfuser;

	public GuiHobbyOrganicInfuser(InventoryPlayer invPlayer, TileEntityHobbyOrganicInfuser teHobbyOrganicInfuser) {
		super(new ContainerHobbyOrganicInfuser(invPlayer, teHobbyOrganicInfuser));
		hobbyOrganicInfuser = teHobbyOrganicInfuser;
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		String name = "Hobbyist Organic Infuser";
