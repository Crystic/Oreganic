...
public class BlockQuartzStem extends BlockStem
{
	private Block field_150925_a;
    private final Block block;
    private Block blockPlantedOn = Blocks.soul_sand;
    @SideOnly(Side.CLIENT)
    private IIcon stemIcon;
	private Random rand = new Random();
	

    public BlockQuartzStem(Block block)
    {
    	super(block);
        this.block = block;
    ...
    {
        return field_150925_a == Oreganic.cropQuartzStem? EnumPlantType.Nether : EnumPlantType.Crop;
    }
    ...
    {
        return Oreganic.cropQuartzSeeds;
    }
    ...
    public boolean canBlockStay (World world, int x, int y, int z) {
    	if(world.getBlock(x, y-1, z) != this.blockPlantedOn) {
    		ItemStack itemstack = new ItemStack(Oreganic.cropQuartzSeeds);
