...
public class BlockGoldStem extends BlockStem
{
    ...
    public BlockGoldStem(Block block)
    {
    	super(block);
        this.block = block;
    ...
    public boolean canBlockStay (World world, int x, int y, int z) {
    	if(world.getBlock(x, y-1, z) != this.blockPlantedOn) {
    		ItemStack itemstack = new ItemStack(Oreganic.cropGoldSeeds);
