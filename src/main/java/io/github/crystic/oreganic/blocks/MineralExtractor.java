...
public class MineralExtractor extends BlockContainer {
	...
	public MineralExtractor(boolean isActive) {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(Oreganic.modid + ":"
				+ "MineralExtractorSide");
		this.iconTop = iconRegister.registerIcon(Oreganic.modid
				+ ":"
				+ (this.isActive ? "MineralExtractorFrontOn"
						: "MineralExtractorFrontOff"));
		this.iconBottom = iconRegister.registerIcon(Oreganic.modid + ":"
				+ "MineralExtractorBottom");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(Oreganic.blockMineralExtractorIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, Oreganic.instance,
					Oreganic.guiIdMineralExtractor, world, x, y, z);
		}
		return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityMineralExtractor) world.getTileEntity(x, y, z))
	...
	public static void updateMineralExtractorBlockState(boolean active,
		...
		if (active) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					Oreganic.blockMineralExtractorActive);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					Oreganic.blockMineralExtractorIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock,
			int oldMetadata) {
		if (!keepInventory) {
			TileEntityMineralExtractor tileentity = (TileEntityMineralExtractor) world
					.getTileEntity(x, y, z);
