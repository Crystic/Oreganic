...
public class BlockRedstoneStem extends BlockStem
{
    ...
    public BlockRedstoneStem(Block block)
    {
    	super(block);
        this.block = block;
    ...
    {
        return Oreganic.cropRedstoneSeeds;
    }
    ...
    public boolean canBlockStay (World world, int x, int y, int z) {
    	if(world.getBlock(x, y-1, z) != this.blockPlantedOn) {
    		ItemStack itemstack = new ItemStack(Oreganic.cropRedstoneSeeds);
