...
public class ContainerHobbyMineralExtractor extends Container {

	private TileEntityHobbyMineralExtractor hobbyMineralExtractor;

	public int lastBurnTime;
	public int lastCurrentItemBurnTime;
	public int lastCookTime;

	public ContainerHobbyMineralExtractor(InventoryPlayer inventory, TileEntityHobbyMineralExtractor tileentity) {
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int slotNum) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (slotNum == 2) {
				...
				if (TileEntityHobbyMineralExtractor.isItemInput(itemstack1)) {
					if (!this.mergeItemStack(itemstack1, 0, 1, false)) {
						return null;
					}
				} else if (TileEntityHobbyMineralExtractor.isItemFuel(itemstack1)) {
