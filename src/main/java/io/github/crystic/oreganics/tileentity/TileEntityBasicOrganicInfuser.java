...
public class TileEntityBasicOrganicInfuser extends TileEntity implements ISidedInventory{
	
	private ItemStack slots[];
	public int dualPower;
	public int dualCookTime;
	public static final int maxPower = 1040;
	...
	public TileEntityBasicOrganicInfuser() {
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			if (flag != this.isInfusing()) {
				flag1 = true;
				BasicOrganicInfuser.updateBlockState(this.isInfusing(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
