...
import io.github.crystic.oreganics.crafting.OrganicInfuserRecipes;
...
public class TileEntityHobbyOrganicInfuser extends TileEntity implements ISidedInventory{
	
	private ItemStack slots[];
	public int dualPower;
	public int dualCookTime;
	public static final int maxPower = 2080;
	public static final int infusionSpeed = 400;
	...
	public TileEntityHobbyOrganicInfuser() {
	...
	public String getInventoryName() {
		return "container.basicOrganicInfuser";
	}
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			if (flag != this.isInfusing()) {
				flag1 = true;
				HobbyOrganicInfuser.updateBlockState(this.isInfusing(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
