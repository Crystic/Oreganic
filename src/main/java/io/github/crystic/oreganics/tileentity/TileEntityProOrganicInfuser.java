...
public class TileEntityProOrganicInfuser extends TileEntity implements ISidedInventory{
	
	private ItemStack slots[];
	public int dualPower;
	public int dualCookTime;
	public static final int maxPower = 4160;
	...
	public TileEntityProOrganicInfuser() {
	...
	public String getInventoryName() {
		return "container.proOrganicInfuser";
	}
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			if (flag != this.isInfusing()) {
				flag1 = true;
				ProOrganicInfuser.updateBlockState(this.isInfusing(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
