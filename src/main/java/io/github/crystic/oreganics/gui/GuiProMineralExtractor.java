...
public class GuiProMineralExtractor extends GuiContainer {

	public static final ResourceLocation bground = new ResourceLocation(
			Oreganic.modid + ":" + "textures/gui/mineralextractor.png");

	public TileEntityProMineralExtractor hobbyMineralExtractor;

	public GuiProMineralExtractor(InventoryPlayer inventoryPlayer, TileEntityProMineralExtractor entity) {
		super(new ContainerProMineralExtractor(inventoryPlayer, entity));
	...
	public void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		String name = "Professional Mineral Extractor";
